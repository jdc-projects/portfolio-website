...
Traefik is a reverse proxy application and can be used as a Kubernetes ingress controller.
placeholder

### Applications

I have a variety of tools, services, and applications on my homelab, including:

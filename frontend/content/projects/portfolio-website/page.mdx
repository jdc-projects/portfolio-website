...
[single container image with whole application] [could split frontend and backend in the future]
...
[branches and per-branch deployment] [link back to architecture diagram, namespace per env]
